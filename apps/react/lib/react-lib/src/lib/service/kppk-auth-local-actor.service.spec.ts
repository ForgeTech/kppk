...
import { FgXstateService } from "./fg-xstate.service";
import { FgAuthLocalMachineService } from "../machine";
import { FgEnvironmentService } from "@kppk/fg-lib-new";
import { KppkAuthLocalActorService } from "./kppk-auth-local-actor.service";
import { test_machine } from "../testing";
import { EventFrom, SnapshotFrom, } from "xstate";

describe( 'KppkAuthLocalActorService', () => {
    ...
    let $service: KppkAuthLocalActorService;
    beforeEach( () => {
        ...
        $service = TestBed.inject(KppkAuthLocalActorService);
        jest.clearAllMocks();
        jest.clearAllTimers();
    });
    ...
    describe('> FgEnvironmentService > development > enabled: true', () => {
        ...
        it('MEMBER: eventS > emits events emitted by test_machine', ()  => {
            const $service = TestBed.inject(KppkAuthLocalActorService);
            const event = {type: 'proceed'} as unknown as EventFrom<typeof $service['machine']>;

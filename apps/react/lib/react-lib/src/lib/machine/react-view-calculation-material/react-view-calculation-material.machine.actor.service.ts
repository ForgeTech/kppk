...
export class ReactViewCalculationMaterialMachineActorService extends FgBaseService implements OnDestroy {
  ...
  public create_from_config( config: ActorOptions<ActorLogicFrom<any>> ) {
    if(this.is_runningS()) {
      this.$log?.warn( 'WARNING: ReactViewCalculationMaterialMachineActorService > create_from_with_config' );

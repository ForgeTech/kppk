...
import { FgAuthLocalMachineActorService } from "./fg-auth-local.machine.actor.service";
import { test_machine } from "../../testing";
import { EventFrom, SnapshotFrom, } from "xstate";

describe( 'FgAuthLocalMachineActorService', () => {
    ...
    let $service: FgAuthLocalMachineActorService;
    beforeEach( () => {
        ...
        $service = TestBed.inject(FgAuthLocalMachineActorService);
        jest.clearAllMocks();
        jest.clearAllTimers();
    });
    ...
    describe('> FgEnvironmentService > development > enabled: true', () => {
        ...
        it('MEMBER: eventS > emits events emitted by test_machine', ()  => {
            const $service = TestBed.inject(FgAuthLocalMachineActorService);
            const event = {type: 'proceed'} as unknown as EventFrom<typeof $service['machine']>;

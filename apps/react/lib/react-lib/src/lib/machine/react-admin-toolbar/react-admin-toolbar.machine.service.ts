    ...
    public get_machine( context?: any ){
      return this.$xstate.setup({
          ...
          actions: {
            ...
            assign_update_context_from_main_auth_actor: this.$xstate.assign( this.$methode.assign_update_context_from_main_auth_actor ),
            raise_internal_update: this.$xstate.raise( this.$methode.raise_internal_update ),
            },
          guards: {

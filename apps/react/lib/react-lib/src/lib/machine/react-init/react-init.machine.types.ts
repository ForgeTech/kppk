...
import { rose_file_data_parser } from '../../types';
import { form_values_parser, react_view_calculation_parser } from '../react-view-calculation';
...
export const debug_calculation_files_parser = z.object({
...
export type DEBUG_CALCULATION_FILES = z.infer<typeof debug_calculation_files_parser>;

export const debug_calculation_parser = z.object({
  ...debug_calculation_files_parser.shape,
  ...form_values_parser.shape
});
export type DEBUG_CALCULATION = z.infer<typeof debug_calculation_parser>;
...
export type REACT_INIT_LOAD_FROM_REMOTE_DATA = z.infer<typeof react_init_load_from_remote_data_parser>;

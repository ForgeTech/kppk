...
export class ReactViewCalculationMaschineService extends FgBaseService {
  protected $calc_materials = inject(ReactCalculationMaterialsService);
  protected $methode = inject(ReactViewCalculationMachineMethodeService);
  ...
  public get_machine( context?: REACT_VIEW_CALCULATION_CONTEXT_V1 ) {
    return this.$xstate.setup({
        ...
        actions: {
          // assign_form_data: this.$xstate.assign(this.$methode.assign_form_data),
          ...
          // raise_form_internal_update: this.$xstate.raise(this.raise_form_internal_update),

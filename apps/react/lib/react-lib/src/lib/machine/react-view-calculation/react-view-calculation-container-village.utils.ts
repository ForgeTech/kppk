...
export const calculate_container_village_results = ( 
  ...
  let energy_type_co2 = unit_kilogramco2_kilowatthour_parser.parse(energy_type.co2_equ);
  ...
  // Calculate energy co2
  let distance_co2_equ = unit_gramco2_kilometer_parser.parse(data.truck.find( item => {

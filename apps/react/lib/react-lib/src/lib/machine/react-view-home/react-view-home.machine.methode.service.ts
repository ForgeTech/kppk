...
export class ReactViewHomeMachineMethodeService extends FgBaseService {
  ...
  @boundMethod
  public react_view_home_output( { context, event }: { context: REACT_VIEW_HOME_CONTEXT, event: any } ) {
    // console.log('>>>>>>>>>>>>>>>>OUTPUT>>>>>>>>>>>>>')
    // console.log( context );
    // console.log( event );
  ...
  @boundMethod
  public assign_from_files_bauteilflaeche_data({ context, event }: { context: REACT_VIEW_HOME_CONTEXT, event: any }) {
  ...
  @boundMethod
  public assign_from_files_aufbauten_data({ context, event }: { context: REACT_VIEW_HOME_CONTEXT, event: any }) {
  ...
  @boundMethod
  public assign_from_files_oi3_data({ context, event }: { context: REACT_VIEW_HOME_CONTEXT, event: any }) {
  ...
  @boundMethod
  public assign_from_files_rose_data({ context, event }: { context: REACT_VIEW_HOME_CONTEXT, event: any }) {
  ...
  @boundMethod
  public assign_from_files_output_data({ context, event }: { context: REACT_VIEW_HOME_CONTEXT, event: any }) {

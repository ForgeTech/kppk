...
import { ReactViewHomeMachineActorService } from "./react-view-home.machine.actor.service";
import { test_machine } from "../../testing";
import { EventFrom, SnapshotFrom, } from "xstate";

describe( 'ReactViewHomeMachineActorService', () => {
    ...
    let $service: ReactViewHomeMachineActorService;
    beforeEach( () => {
        ...
        $service = TestBed.inject(ReactViewHomeMachineActorService);
        jest.clearAllMocks();
        jest.clearAllTimers();
    });

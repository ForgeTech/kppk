 ...
 * state machine
 */
export abstract class FgMachineActorAbstract<T extends AnyStateMachine> extends FgBaseService {
  ...
  public readonly eventsS = toSignal<EmittedFrom<T> | undefined>(this.event$, { initialValue: undefined });
  
  protected STATE$ = new Subject<SnapshotFrom<T>>();
  public readonly state$ = this.STATE$.asObservable();
  public readonly stateS = toSignal<EmittedFrom<T> | undefined>(this.event$, { initialValue: undefined });

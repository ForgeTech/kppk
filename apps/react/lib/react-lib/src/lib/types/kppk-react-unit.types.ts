...
export const add_number_units = <T extends { value: number, unit: number | string, type: 'number' }>( target: T, toAdd: T) => {
...
export const applyEditsToTarget = <T>( context: any, draft:any, changes_obj: any, round: number = 3, edited: boolean = true): T => {
  (Object.keys( changes_obj ) as any[] ).forEach( key => {
    ...
    // for object
      ...
      draft[ key ] = applyEditsToTarget(context[ key ], draft[ key ], changes_obj[ key ] );
    }
    // for array
    else if (  Array.isArray(context[key]) ) {
      for( let index = 0; index < context[key].length; index++ ) {
        draft[ key ][index] = applyEditsToTarget(context[ key ][ index ], draft[ key ][ index ], changes_obj[ key ][ index ] );
      }
    }
...
export const unit_id_parser = 
z.number().transform( value => { return { value: value.toString(), unit: 'id' as const} })
.or(z.string().transform( value => { return { value: value, unit: 'id' as const} }))
.or(z.object({
  value: z.string(),
...
export const unit_floor_parser = number_type_unit_base.extend({
  value: z.number().or(z.null().transform( () => 1)).or(z.string().transform( value => parseFloat(value) )).default(1),
...
export const unit_liter_hundred_kilometers_parser = number_type_unit_base.extend({
  value: z.number(),
  unit: z.literal('l/100km').default('l/100km'),
});
export type UNIT_LITER_100KM = z.infer<typeof unit_liter_hundred_kilometers_parser>;
...
export const unit_meter_square_parser = number_type_unit_base.extend({
  value: z.number().or(z.null().transform( () => 0)).or(z.string().transform( value => parseFloat(value) )).default(0),
  unit: z.literal('m2').or(z.literal('m²').transform( () => 'm2' as const)).default('m2'),
});
...
export const unit_meter_cubic_parser = number_type_unit_base.extend({
  value: z.number().or(z.null().transform( () => 0)).or(z.string().transform( value => parseFloat(value) )).default(0),
  unit: z.literal('m3').or(z.literal('m³').transform( () => 'm3' as const)).default('m3'),
});
...
export const unit_oi3_meter_square_parser = number_type_unit_base.extend({
  value: z.number().or(z.null().transform( () => 0)).or(z.string().transform( value => parseFloat(value) )).default(0),
  unit: z.literal('oi3/m2').or(z.literal('oi3/m²').transform( () => 'oi3/m2' as const )).default('oi3/m2'),
});
...
export const unit_mj_meter_square_parser = number_type_unit_base.extend({
  value: z.number().or(z.null().transform( () => 0)).or(z.string().transform( value => parseFloat(value) )).default(0),
  unit: z.literal('MJ/m2').or(z.literal('MJ/m²').transform( () => 'MJ/m2' as const )).default('MJ/m2'),
});
...
export const unit_kilogram_meter_cubic_parser = number_type_unit_base.extend({
  value: z.number().or(z.null().transform( () => 0)).or(z.string().transform( value => parseFloat(value) )).default(0),
  unit: z.literal('kg/m3').or(z.literal('kg/m³').transform( () => 'kg/m3' as const)).default('kg/m3'),
});
...
export const unit_kilogram_meter_square_parser = number_type_unit_base.extend({
  value: z.number().or(z.null().transform( () => 0)).or(z.string().transform( value => parseFloat(value) )).default(0),
  unit: z.literal('kg/m2').or(z.literal('kg/m²').transform( () => 'kg/m2' as const)).default('kg/m2'),
});
export type UNIT_KG_M2 = z.infer<typeof unit_kilogram_meter_square_parser>;

export const unit_kilogram_co2_meter_square_parser = number_type_unit_base.extend({
  value: z.number().or(z.null().transform( () => 0)).or(z.string().transform( value => parseFloat(value) )).default(0),
  unit: z.literal('kgCo2/m2').or(z.literal('kgCo²/m²').transform( () => 'kgCO2/m2' as const)).default('kgCo2/m2'),
});
export type UNIT_KGCO2_M2 = z.infer<typeof unit_kilogram_co2_meter_square_parser>;

export const unit_kilogram_co2_parser = number_type_unit_base.extend({
  value: z.number().or(z.null().transform( () => 0)).or(z.string().transform( value => parseFloat(value) )).default(0),
  unit: z.string().transform( value => 'kgCo2' as const ).or(z.literal('kgCo2').or(z.literal('kgCo²').transform( () => 'kgCo2' as const)).default('kgCo2')),
});
...
export const unit_kilogramco2_kilometer_parser = number_type_unit_base.extend({
  value: z.number().or(z.null().transform( () => 0)).or(z.string().transform( value => parseFloat(value) )).default(0),
  unit: z.literal('kgCo2/km').or(z.literal('kgCo²/km').transform( () => 'kgCo2/km' as const)).default('kgCo2/km'),
});
...
export const unit_kilogramco2_kilogram_parser = number_type_unit_base.extend({
  value: z.number().or(z.null().transform( () => 0)).or(z.string().transform( value => parseFloat(value) )).default(0),
  unit: z.literal('kgCo2/kg').or(z.literal('kgCo²/kg').transform( () => 'kgCo2/kg' as const)).default('kgCo2/kg'),
});
export type UNIT_KGCO2_KG = z.infer<typeof unit_kilogramco2_kilogram_parser>;

export const unit_kilogramco2_kilowatthour_parser = number_type_unit_base.extend({
  value: z.number().or(z.null().transform( () => 0)).or(z.string().transform( value => parseFloat(value) )).default(0),
  unit: z.literal('kgCo2/kWh').or(z.literal('kgCo²/kWh').transform( () => 'kgCo2/kWh' as const)).default('kgCo2/kWh'),
});
export type UNIT_KGCO2_KWH = z.infer<typeof unit_kilogramco2_kilowatthour_parser>;

export const unit_kilogramco2_liter_parser = number_type_unit_base.extend({
  value: z.number().or(z.null().transform( () => 0)).or(z.string().transform( value => parseFloat(value) )).default(0),
  unit: z.literal('kgCo2/l').or(z.literal('kgCo²/l').transform( () => 'kgCo2/l' as const)).default('kgCo2/l'),
});
...
export const unit_watt_metersquarekelvin_parser = number_type_unit_base.extend({
  value: z.number().or(z.null().transform( () => 0)).or(z.string().transform( value => parseFloat(value) )).default(0),
  unit: z.literal('W/m2K').or(z.literal('W/m²K').transform( () => 'W/m2K' as const)).default('W/m2K'),
});
...
export const unit_tonco2_parser = number_type_unit_base.extend({
  value: z.number().or(z.null().transform( () => 0)).or(z.string().transform( value => parseFloat(value) )).default(0),
  unit: z.literal('tCo2').or(z.literal('tCo²').transform( () => 'tCo2' as const)).default('tCo2'),
});
export type UNIT_TCO2 = z.infer<typeof unit_tonco2_parser>;

export const unit_tonco2_year_parser = number_type_unit_base.extend({
  value: z.number().or(z.null().transform( () => 0)).or(z.string().transform( value => parseFloat(value) )).default(0),
  unit: z.literal('tCo2/year').or(z.literal('tCo²/year').transform( () => 'tCo2/year' as const)).default('tCo2/year'),
});
...
export const unit_tonco2_xyear_parser = number_type_unit_base.extend({
  value: z.number().or(z.null().transform( () => 0)).or(z.string().transform( value => parseFloat(value) )).default(0),
  unit: z.literal('tCo2/xyear').or(z.literal('tCo²/xyear').transform( () => 'tCo2/xyear' as const)).default('tCo2/xyear'),
});
...
export const unit_gramco2_kilometer_parser = number_type_unit_base.extend({
  value: z.number().or(z.null().transform( () => 0)).or(z.string().transform( value => parseFloat(value) )).default(0),
  unit: z.literal('gCo2/km').or(z.literal('gCo²/km').transform( () => 'gCo2/km' as const)).default('gCo2/km'),
})
export type UNIT_GCO2_KM = z.infer<typeof unit_gramco2_kilometer_parser>;

export const unit_gramco2_kilometerkilogram_parser = number_type_unit_base.extend({
  value: z.number(),
  unit: z.literal('gCo2/km*kg').or(z.literal('gCo²/km*kg').transform( () => 'gCo2/km*kg' as const)).default('gCo2/km*kg'),
})
export type UNIT_GCO2_KMKG = z.infer<typeof unit_gramco2_kilometerkilogram_parser>;

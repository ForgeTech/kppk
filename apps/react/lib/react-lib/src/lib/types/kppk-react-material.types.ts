...
export type MATERIAL_CO2_EQU_ITEM = z.infer<typeof material_co2_equ_item_parser>;
...
export const material_category_parser = z.array(
  ...
  export type MATERIAL_DENSITY_DATA_ITEM = z.infer<typeof material_density_item_parser>;
  
  export const material_density_data_parser = z.array(material_density_item_parser);
  export type MATERIAL_DENSITY_DATA = z.infer<typeof material_density_data_parser>;
  ...
  export const form_window_value_parser = z.object({
    ...
    window_part_type_glass_id: z.undefined().or(unit_id_parser.optional().default(0)),
    window_part_type_glass: z.undefined().or(z.any().optional().default({})),
    window_part_type_frame_id: z.undefined().or(unit_id_parser.optional().default(0)),
  ...
  export const form_materials_result_item_parser = z.object({
    ...
    gwp: unit_kilogram_co2_parser.optional().default({}),
    // gwp_oeko_id: unit_id_parser.optional().default(0),
    gwp_oeko: unit_string_parser.or(unit_kilogram_co2_parser).optional().default({ value: '-'}),
    // shipments: unit_number_parser.optional().default({}),
    // distance: unit_kilometer_parser.optional().default({ value: 100 }),
    co2_transport: unit_kilogram_co2_parser.optional().default({}),
  });
  export type FORM_MATERIALS_RESULT_ITEM = z.infer<typeof form_materials_result_item_parser>

  export const form_materials_result_parser = z.array(form_materials_result_item_parser)
  export type FORM_MATERIALS_RESULT = z.infer<typeof form_materials_result_parser>

  ...
  <div class="flex flex-col"  *transloco="let t;">
    ...
    <div class="relative h-72">
      ...
      <table class="table-legend absolute bottom-[60px] right-[10px]">
        <tr class="text-xs" [ngStyle]="{'background-color': this.$colors.concrete }">
          <td>GWP</td>
        <tr>
        <tr class="text-xs" [ngStyle]="{'background-color': this.$colors.concrete_oeko}">
          <td>GWP Öko</td>
        <tr>
        <tr class="text-xs" [ngStyle]="{'background-color': this.$colors.transport}">
          <td>CO₂ Transport</td>
        <tr>
      </table>
    </div>

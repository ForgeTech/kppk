...
import { KppkReactContainerVillageFields } from './kppk-react-container-village.fields.service';
import { KppkReactExcavationPitFields } from './kppk-react-excavation-pit.fields.service';
import { KppkReactDemolishDisposalFields } from './kppk-react-demolish-disposal.fields.service';
import { KppkReactCommonFields } from './kppk-react-common.fields.service';
import { KppkReactHeatingSystemFields } from './kppk-react-heating-system.fields.service';
import { FormlyFormOptions } from '@ngx-formly/core';
import { NgObjectPipesModule } from 'ngx-pipes';
import { KppkReactMaterialsComponent } from './kppk-react-materials/kppk-react-materials.component';
import { MatStepperModule } from '@angular/material/stepper';
import { MatCheckboxModule } from '@angular/material/checkbox';
import { MatCardModule } from '@angular/material/card';
import { react_view_calculation_form_name_enum } from '../../types/kppk-react-calculation.types';
import { KppkReactResultsComponent } from './kppk-react-results/kppk-react-results.component';
...
@Component({
  ...
  templateUrl: './kppk-react-calc-view.component.html',
  styleUrl: './kppk-react-calc-view.component.scss',
...
export class KppkReactCalcViewComponent extends KppkReactBaseComponent {
  ...
  protected form_common_model_s = computed( () => {
    ...
    this.$component.$log.fatal('UPDATED_COMMON_MODEL');
    this.$component.$log.fatal(JSON.stringify( result ));
    return result;
  })
  ...
  // protected assign_form_data( cont)
}

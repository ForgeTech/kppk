...
export class KppkReactExcavationPitFields extends FgBaseService {
  ...
  protected hide_unequal_jet_blasting_process = (
  ...
  protected hide_unequal_jet_blasting_process_type_cylinder = (
    field: FormlyFieldConfig<
      FormlyFieldProps & {
        [additionalProperties: string]: any;
      }
  ...
  protected hide_unequal_jet_blasting_process_type_cuboid = (
    field: FormlyFieldConfig<
      FormlyFieldProps & {
        [additionalProperties: string]: any;
      }
  ...
  protected hide_unequal_escarpment_process = (
    field: FormlyFieldConfig<
      FormlyFieldProps & {
        [additionalProperties: string]: any;
      }
  ...
  protected hide_unequal_sheet_pile_wall_process = (
    field: FormlyFieldConfig<
      FormlyFieldProps & {
        [additionalProperties: string]: any;
      }
  ...
  protected hide_unequal_shotcrete_process = (
    field: FormlyFieldConfig<
      FormlyFieldProps & {
        [additionalProperties: string]: any;
      }
  ...
  protected hide_unequal_foundation_pile_process = (
    field: FormlyFieldConfig<
      FormlyFieldProps & {
        [additionalProperties: string]: any;
      }

...
import { FG_FORM_EXCAVATION_PIT_CONTEXT, UNIT_GENERAL } from '@kppk/react-lib';
...
export class KppkReactViewCalculationPrintFormExcavationPitComponent {
  public input_dataS = input<FG_FORM_EXCAVATION_PIT_CONTEXT | undefined>(undefined, {alias: 'data'});

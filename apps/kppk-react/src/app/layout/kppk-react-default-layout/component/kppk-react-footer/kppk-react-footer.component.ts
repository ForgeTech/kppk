...
@Component({
  ...
  template: `
    <div
      class="flex h-[28px] flex-row items-center justify-center gap-2 px-4 py-1"
    >
      <div class="flex-auto"></div>
      <div class="flex-initial text-xs">
        <a href="https://kppk.at/" target="_blank">
          <span class="relative top-[1px]"
            >KPPK Ziviltechniker GmbH &copy;{{ current_year }}</span
          >
        </a>
      </div>
      <a href="https://kppk.at/" target="_blank">

...
export const unit_excavation_pit_security_methode_enum_parser = z.object({
  value: z
    .nativeEnum(EXCAVATION_PIT_SECURITY_METHODE_ENUM)
    .default(EXCAVATION_PIT_SECURITY_METHODE_ENUM.jet_blasting),
  unit: z.literal('').default(''),
});
export type UNIT_EXCAVATION_PIT_SECURITY_METHODE = z.infer<
  typeof unit_excavation_pit_security_methode_enum_parser
>;

export const unit_jet_blasting_process_type_enum_parser = z.object({
  value: z
    .nativeEnum(JET_BLASTING_PROCESS_TYPE_ENUM)
    .default(JET_BLASTING_PROCESS_TYPE_ENUM.process_type_cylinder),
  unit: z.literal('').default(''),
});
export type UNIT_JET_BLASTING_PROCESS = z.infer<
  typeof unit_jet_blasting_process_type_enum_parser
>;

export const unit_jet_blasting_process_cylinder_shape_enum_parser = z.object({
  value: z
    .nativeEnum(JET_BLASTING_PROCESS_CYLINDER_SHAPE_ENUM)
    .default(JET_BLASTING_PROCESS_CYLINDER_SHAPE_ENUM.full_circle),
  unit: z.literal('').default(''),
});
export type UNIT_JET_BLASTING_PROCESS_CYLINDER_SHAPE = z.infer<
  typeof unit_jet_blasting_process_cylinder_shape_enum_parser
>;

export const result_excavation_pit_parser = z.object({
  // linear_meter: unit_meter_parser.optional().default({}),
  excavation_pit_security: z
    .object({
      linear_meter: unit_meter_parser.optional().default({}),
    ...
    .optional()
    .default({}),
  jet_blasting_process: z
    .object({
      jet_blasting_process_cylinder: z
        .object({
...
export type RESULT_EXCAVATION_PIT = z.infer<
  typeof result_excavation_pit_parser
>;
...
export const form_excavation_pit_parser = z.object({
  excavation_pit_security: z
    .object({
      ...
      methode: unit_excavation_pit_security_methode_enum_parser
        .optional()
        .default({}),
  ...
  jet_blasting_process: z
    .object({
      ...
      process_type: unit_jet_blasting_process_type_enum_parser
        .optional()
        .default({}),
      jet_blasting_process_cylinder: z
        .object({
          diameter: unit_meter_parser.optional().default({}),
          shape: unit_jet_blasting_process_cylinder_shape_enum_parser
            .optional()
            .default({}),
        })
        .optional()
...
export type FORM_EXCAVATION_PIT_DATA = z.infer<
  typeof form_excavation_pit_parser
>;

...
export const rose_file_data_parser = z
  .object({
...
export type FORM_HEATING_SYSTEM_RESULT = z.infer<
  typeof form_heating_system_result_parser
>;

export const form_heating_system_data_parser = z
  .object({
  ...
  .optional()
  .default({});
export type FORM_HEATING_SYSTEM_DATA = z.infer<
  typeof form_heating_system_data_parser
>;

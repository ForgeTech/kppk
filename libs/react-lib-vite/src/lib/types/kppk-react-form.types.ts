...
export const react_view_calculation_form_name_enum_parser = z.nativeEnum(
  REACT_VIEW_CALCULATION_FORM_NAME_ENUM
);

export const fg_form_context = z.object({
  name: react_view_calculation_form_name_enum_parser
    .optional()
    .default(REACT_VIEW_CALCULATION_FORM_NAME_ENUM.unnamed),
...
export type FG_FORM_MATERIAL_CONTEXT_RESULTS = z.infer<
  typeof form_material_context_results_parser
>;
...
export type FG_FORM_MATERIAL_CONTEXT = z.infer<
  typeof form_material_context_parser
>;
...
export type FG_FORM_WINDOW_CONTEXT_RESULTS = z.infer<
  typeof form_window_context_results_parser
>;
...
export type FG_FORM_CONCRETE_CONTEXT_RESULTS = z.infer<
  typeof form_concrete_context_results_parser
>;
...
export type FG_FORM_CONCRETE_CONTEXT = z.infer<
  typeof form_concrete_context_parser
>;
...
export type FG_FORM_CONSTRUCTION_SITE_CONTEXT = z.infer<
  typeof form_construction_site_context_parser
>;
...
export type FG_FORM_CONTAINER_VILLAGE_CONTEXT = z.infer<
  typeof form_container_village_context_parser
>;
...
export type FG_FORM_DEMOLISH_DISPOSAL_CONTEXT = z.infer<
  typeof form_demolish_disposal_context_parser
>;

export const form_excavation_pit_context_parser = fg_form_context.extend({
  value: form_excavation_pit_parser.optional().default({}),
});
export type FG_FORM_EXCAVATION_PIT_CONTEXT = z.infer<
  typeof form_excavation_pit_context_parser
>;
...
export type FG_FORM_HEATING_SYSTEM_CONTEXT = z.infer<
  typeof form_heating_system_context_parser
>;

export const form_step_selection_context_parser = fg_form_context.extend({
  value: form_step_selection_data.optional().default({}),
});
export type FG_FORM_STEP_SELECTION_SYSTEM_CONTEXT = z.infer<
  typeof form_excavation_pit_context_parser
>;
...
export const form_values_parser = z.object({
  ...
  form_construction_site: form_construction_site_context_parser
    .optional()
    .default({
      name: REACT_VIEW_CALCULATION_FORM_NAME_ENUM.construction_site,
    }),
  form_container_village: form_container_village_context_parser
    .optional()
    .default({
      name: REACT_VIEW_CALCULATION_FORM_NAME_ENUM.container_village,
    }),
  form_demolish_disposal: form_demolish_disposal_context_parser
    .optional()
    .default({

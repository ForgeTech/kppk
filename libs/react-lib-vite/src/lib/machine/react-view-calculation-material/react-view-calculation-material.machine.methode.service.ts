...
import {
  transform_oi3,
  transform_bauteilflaechen,
  transform_aufbauten,
} from './react-view-calculation-material.utils';
import {
  REACT_CALCULATION_MATERIALS_CONTEXT,
  REACT_CALCULATION_MATERIALS_INPUT,
} from '../../types';
...
export class ReactCalculationMaterialMachineMethodeService extends FgBaseService {
  ...
  @boundMethod
  public assign_oi3_transform_result({
    context,
    event,
  }: {
  ...
  @boundMethod
  public assign_bauteilflaechen_transform_result({
    context,
    event,
  }: {
    context: REACT_CALCULATION_MATERIALS_CONTEXT;
  ...
  @boundMethod
  public assign_aufbauten_transform_result({
    context,
    event,
  }: {
    context: REACT_CALCULATION_MATERIALS_CONTEXT;
  ...
  @boundMethod
  public async actor_tranform_oi3_file_inputs({
    input,
  }: {
  ...
  @boundMethod
  public async actor_tranform_bauteilflaechen_file_inputs({
    input,
  }: {
    input: REACT_CALCULATION_MATERIALS_INPUT;
  }) {
  ...
  @boundMethod
  public async actor_tranform_aufbauten_file_inputs({
    input,
  }: {
    input: REACT_CALCULATION_MATERIALS_INPUT;
  }) {

      ...
      .setup({
        ...
        actions: {
          assign_set_context: this.$xstate.assign(
            this.$methode.assign_set_context
          ),
          assign_set_progress: this.$xstate.assign(
            this.$methode.assign_set_progress
          ),
          escalate_timeout_error: this.$methode.escalate_timeout_error,
          raise_spinner_event_stop: this.$xstate.raise(
            this.$methode.raise_spinner_event_stop
          ),
          raise_spinner_internal_hide: this.$xstate.raise(
            this.$methode.raise_spinner_internal_hide
          ),
          raise_spinner_internal_show: this.$xstate.raise(
            this.$methode.raise_spinner_internal_show
          ),
          respond_spinner_event_context: this.$xstate.sendTo(
            this.$methode.respond_spinner_event_context_get_target,
            this.$methode.respond_spinner_event_context_get_event
          ),

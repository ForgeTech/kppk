      ...
      .setup({
        types: {
          ...
          events: {} as
            ...
            | {
                type: 'react.view.home.event.from_local_storage.ready';
                data: any;
              }
        ...
        actions: {
          assign_from_files_bauteilflaeche_data: this.$xstate.assign(
            this.$methode.assign_from_files_bauteilflaeche_data
          ),
          assign_from_files_aufbauten_data: this.$xstate.assign(
            this.$methode.assign_from_files_aufbauten_data
          ),
          assign_from_files_oi3_data: this.$xstate.assign(
            this.$methode.assign_from_files_oi3_data
          ),
          assign_from_files_rose_data: this.$xstate.assign(
            this.$methode.assign_from_files_rose_data
          ),
          assign_from_files_output_data: this.$xstate.assign(
            this.$methode.assign_from_files_output_data
          ),
        },
      })
      .createMachine({
                  ...
                  UNSELECTED: {
                    on: {
                      'react.view.home.event.modal.from_files': {
                        target:
                          '#REACT_VIEW_HOME_V2.MODAL.SHOWN.SELECTED.FROM_FILES',
                      },

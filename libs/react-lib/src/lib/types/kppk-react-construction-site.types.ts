...
export const construction_site_build_type_enum_parser = z.object({
  value: z
    .nativeEnum(BUILD_TYPE_ENUM)
    .default(BUILD_TYPE_ENUM.building_construction),
  unit: z.literal('').default(''),
});
export type construction_site_build_type_enum = z.infer<
  typeof construction_site_build_type_enum_parser
>;

export const construction_energy_usage_site_power_type_enum_parser = z.object({
  value: z
    .nativeEnum(POWER_SUPPLY_POWER_TYPE_ENUM)
    .default(POWER_SUPPLY_POWER_TYPE_ENUM.austria_common_energy_mix),
  unit: z.literal('').default(''),
});
export type construction_energy_usage_site_power_typen_enum = z.infer<
  typeof construction_energy_usage_site_power_type_enum_parser
>;
...
export type CONSTRUCTION_SITE_ENERGY_USAGE_ITEM = z.infer<
  typeof construction_site_energy_usage_item_parser
>;

export const construction_site_energy_usage_data_parser = z.array(
  construction_site_energy_usage_item_parser
);
export type CONSTRUCTION_SITE_ENERGY_USAGE_DATA = z.infer<
  typeof construction_site_energy_usage_data_parser
>;

export const construction_site_energy_usage_year_energy_usage_item_parser =
  z.object({
...
export type CONSTRUCTION_SITE_ENERGY_USAGE_YEAR_ENERGY_USAGE_ITEM_EXACT =
  z.infer<typeof construction_site_energy_usage_year_energy_usage_item_parser>;

export const construction_site_energy_usage_year_energy_usage_parser = z
  .array(
    construction_site_energy_usage_year_energy_usage_item_parser
      .optional()
      .default({})
  )
  .optional()
  .default([]);
export type CONSTRUCTION_SITE_ENERGY_USAGE_YEAR_ENERGY_USAGE_EXACT = z.infer<
  typeof construction_site_energy_usage_year_energy_usage_parser
>;

export const construction_site_energy_usage_exact_energy_usage_parser = z
  .array(construction_site_energy_usage_item_parser)
  .optional()
  .default([]);
export type CONSTRUCTION_SITE_ENERGY_USAGE_EXACT_ENERGY_USAGE = z.infer<
  typeof construction_site_energy_usage_data_parser
>;
...
export const result_construction_site_parser = z.object({
  power_supply: z
    .object({
      energy_usage_estimate: unit_kilowatthours_month_parser
        .optional()
        .default({}),
  ...
  heating_supply: z
    .object({
      energy_usage_estimate: unit_megawatthours_month_parser
        .optional()
        .default({}),
...
export type RESULT_CONSTRUCTION_SITE = z.infer<
  typeof result_construction_site_parser
>;

export const form_construction_site_parser = z.object({
  energy_usage_settings: z
    .object({
      energy_usage_power_type:
        construction_energy_usage_site_power_type_enum_parser
          .optional()
          .default({}),
      energy_usage_build_type: construction_site_build_type_enum_parser
        .optional()
        .default({}),
  ...
  energy_usage_values: z
    .object({
      operation_period: unit_month_parser.optional().default({}),
      gross_floor_area: unit_meter_square_parser.optional().default({}),
      energy_usage_custom: unit_kilowatthours_month_parser
        .optional()
        .default({}),
      year_energy_usage: construction_site_energy_usage_year_energy_usage_parser
        .optional()
        .default([]),
    })
    .optional()
  ...
  heating_supply_values: z
    .object({
      operation_period: unit_month_parser.optional().default({}),
      gross_floor_area: unit_meter_square_parser.optional().default({}),
      energy_usage_custom: unit_megawatthours_month_parser
        .optional()
        .default({}),
      year_energy_usage: construction_site_energy_usage_year_energy_usage_parser
        .optional()
...
export type FORM_CONSTRUCTION_SITE = z.infer<
  typeof form_construction_site_parser
>;

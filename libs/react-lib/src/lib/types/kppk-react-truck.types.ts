...
export const truck_container_10cubic_or_roll_off_parser = z.object({
  value: z
    .literal('10_cubic_meter_container')
    .or(z.literal('roll_off_container'))
    .optional()
    .default('10_cubic_meter_container'),
  unit: z.literal('').optional().default(''),
});
export type TRUCK_CONTAINER_10CUBIC_OR_ROLLOFF_TYPE = z.infer<
  typeof truck_container_10cubic_or_roll_off_parser
>;

...
export type CONTAINER_VILLAGE_FORM_ENERGY_VALUE = z.infer<
  typeof container_village_form_energy_value_parser
>;

export const container_village_form_settings_parser = z.object({
  distance: unit_kilometer_parser.optional().default({}),
  energy_usage_power_type: construction_energy_usage_site_power_type_enum_parser
    .optional()
    .default({}),
});
export type CONTAINER_VILLAGE_FORM_SETTINGS = z.infer<
  typeof container_village_form_settings_parser
>;
...
export type CONTAINER_VILLAGE_FORM_ENERGY = z.infer<
  typeof container_village_form_energy_parser
>;
...
export type CONTAINER_VILLAGE_ENERGY_WEEK_CATEGORY_VALUES = z.infer<
  typeof container_village_energy_week_category_value_parser
>;
...
export type CONTAINER_VILLAGE_ENERGY_DATA = z.infer<
  typeof container_village_energy_data_parser
>;

export const container_village_energy_week_category_with_sum_week_and_month_value_parser =
  container_village_energy_week_category_value_parser.extend({
    key: z.string(),
    energy_week: unit_kilowatthours_week_parser,
    energy_month: unit_kilowatthours_month_parser,
  });
export type CONTAINER_VILLAGE_ENERGY_WEEK_CATEGORY_WITH_SUM_WEEK_MONTH_VALUE =
  z.infer<
    typeof container_village_energy_week_category_with_sum_week_and_month_value_parser
  >;

export const container_village_energy_info_parser = z.array(
  container_village_energy_week_category_with_sum_week_and_month_value_parser
);
export type CONTAINER_VILLAGE_ENERGY_INFO = z.infer<
  typeof container_village_energy_info_parser
>;
...
export type CONTAINER_VILLAGE_ENERGY_RESULT_ITEM = z.infer<
  typeof container_village_energy_result_item
>;

export const container_village_energy_result_parser = z.array(
  container_village_energy_result_item
);
export type CONTAINER_VILLAGE_ENERGY_RESULT = z.infer<
  typeof container_village_energy_result_parser
>;
...
export const container_village_transport_result_item_container_sum_parser =
  z.object({
    container_sum: unit_pieces_parser,
  });
export type CONTAINER_VILLAGE_TRANSPORT_RESULT_ITEM_CONTAINER_SUM = z.infer<
  typeof container_village_transport_result_item_container_sum_parser
>;
...
export type CONTAINER_VILLAGE_TRANSPORT_RESULT_ITEM_DISTANCE = z.infer<
  typeof container_village_transport_result_item_distance_parser
>;

export const container_village_transport_result_item_distance_sum_parser =
  z.object({
    distance_sum: unit_kilometer_parser,
  });
export type CONTAINER_VILLAGE_TRANSPORT_RESULT_ITEM_CONTAINER_DISTANCE_SUM =
  z.infer<typeof container_village_transport_result_item_distance_sum_parser>;

export const container_village_transport_result_item_distance_co2 = z.object({
  distance_co2: unit_kilogram_co2_parser,
});
export type CONTAINER_VILLAGE_TRANSPORT_RESULT_ITEM_DISTANCE_CO2 = z.infer<
  typeof container_village_transport_result_item_distance_co2
>;
...
export type CONTAINER_VILLAGE_TRANSPORT_RESULT = z.infer<
  typeof container_village_transport_result_parser
>;
...
export type CONTAINER_VILLAGE_RESULT = z.infer<
  typeof container_village_result_parser
>;
...
export type FORM_CONTAINER_VILLAGE = z.infer<
  typeof form_container_village_parser
>;

...
export const react_calculation_materials_file_data =
  calculation_files_parser.omit({ file_rose: true });
export type REACT_CALCULATION_MATERIALS_FILE_DATA = z.infer<
  typeof react_calculation_materials_file_data
>;
...
export type REACT_CALCULATION_MATERIALS_OUTPUT = z.infer<
  typeof react_calculation_materials_output
>;
...
export type REACT_CALCULATION_MATERIALS_CONTEXT = z.infer<
  typeof react_calculation_materials_context
>;
...
export type REACT_CALCULATION_MATERIALS_INPUT = z.infer<
  typeof react_calculation_materials_input
>;

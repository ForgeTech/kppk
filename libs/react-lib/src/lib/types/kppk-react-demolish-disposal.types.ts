...
export type CONTAINER_DISPOSAL_DATA_ITEM = z.infer<
  typeof container_disposal_item_parser
>;

export const container_disposal_parser = z.array(
  container_disposal_item_parser
);
...
export type FORM_MATERIAL_ITEM = z.infer<
  typeof demolish_disposal_form_material_item_parser
>;

export const demolish_disposal_form_material_section_parser = z
  .object({
    concrete: demolish_disposal_form_material_item_parser
      .optional()
      .default({}),
    ...
    plasterboard: demolish_disposal_form_material_item_parser
      .optional()
      .default({}),
    ...
    wood_massive: demolish_disposal_form_material_item_parser
      .optional()
      .default({}),
    wood_material: demolish_disposal_form_material_item_parser
      .optional()
      .default({}),
    wood_latch: demolish_disposal_form_material_item_parser
      .optional()
      .default({}),
  })
  .optional()
  .default({});
export type DEMOLISH_DISPOSAL_FORM_MATERIAL_SECTION = z.infer<
  typeof demolish_disposal_form_material_section_parser
>;

export const demolish_disposal_form_insulation_section_parser = z
  .object({
    eps: demolish_disposal_form_material_item_parser.optional().default({}),
    glass_wool: demolish_disposal_form_material_item_parser
      .optional()
      .default({}),
    rock_wool: demolish_disposal_form_material_item_parser
      .optional()
      .default({}),
    wood_fibre: demolish_disposal_form_material_item_parser
      .optional()
      .default({}),
  ...
  .optional()
  .default({});
export type DEMOLISH_DISPOSAL_FORM_INSULATION_SECTION = z.infer<
  typeof demolish_disposal_form_insulation_section_parser
>;

export const demolish_disposal_form_setting_parser = z
  .object({
    distance: unit_kilometer_parser.optional().default({ value: 100 }),
  ...
  .optional()
  .default({});
export type DEMOLISH_DISPOSAL_FORM_SETTING = z.infer<
  typeof demolish_disposal_form_setting_parser
>;
...
export const demolish_disposal_form_result_item_parser = z.object({
  ...
  capacity: unit_meter_cubic_parser
    .optional()
    .default({})
    .or(unit_kilogram_parser)
    .optional()
    .default({}),
...
export type DEMOLISH_DISPOSAL_FORM_RESULT_ITEM = z.infer<
  typeof demolish_disposal_form_result_item_parser
>;

export const demolish_disposal_form_material_section_result_parser = z
  .object({
    ...
    plasterboard: demolish_disposal_form_result_item_parser
      .optional()
      .default({}),
    ...
    wood_massive: demolish_disposal_form_result_item_parser
      .optional()
      .default({}),
    wood_material: demolish_disposal_form_result_item_parser
      .optional()
      .default({}),
    wood_latch: demolish_disposal_form_result_item_parser
      .optional()
      .default({}),
  })
  .optional()
  .default({});
export type DEMOLISH_DISPOSAL_FORM_MATERIAL_SECTION_RESULT = z.infer<
  typeof demolish_disposal_form_material_section_result_parser
>;

export const demolish_disposal_form_insulation_section_result_parser = z
  .object({
    eps: demolish_disposal_form_result_item_parser.optional().default({}),
    glass_wool: demolish_disposal_form_result_item_parser
      .optional()
      .default({}),
    rock_wool: demolish_disposal_form_result_item_parser.optional().default({}),
    wood_fibre: demolish_disposal_form_result_item_parser
      .optional()
      .default({}),
  ...
  .optional()
  .default({});
export type DEMOLISH_DISPOSAL_FORM_INSULATION_SECTION_RESULT = z.infer<
  typeof demolish_disposal_form_insulation_section_result_parser
>;

export const demolish_disposal_form_result_parser = z.object({
  material_section_result: demolish_disposal_form_material_section_result_parser
    .optional()
    .default({}),
  insulation_section_result:
    demolish_disposal_form_material_section_result_parser
      .optional()
      .default({}),
...
export type DEMOLISH_DISPOSAL_FORM_RESULT = z.infer<
  typeof demolish_disposal_form_result_parser
>;
...
export const demolish_disposal_form_material_parser = z.object({
  ...
  material: demolish_disposal_form_material_section_parser
    .optional()
    .default({}),
  insulation: demolish_disposal_form_insulation_section_parser
    .optional()
    .default({}),
  results: demolish_disposal_form_result_parser.optional().default({}),
});

export type DEMOLISH_DISPOSAL_FORM_MATERIAL = z.infer<
  typeof demolish_disposal_form_material_parser
>;

...
export interface FormlyDigitInputFieldConfig
  extends FormlyFieldConfig<InputNumberDigitProps> {
  type: 'input-number-digit' | Type<FgFormlyFieldNumberDigitInputComponent>;
}

@Component({
  imports: [MatInputModule, DigitOnlyModule],
  selector: 'fg-formly-field-digit-type',
  template: './fg-formly-field-digit-type.component.html',
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class FgFormlyFieldNumberDigitInputComponent extends FieldType<
  FieldTypeConfig<InputNumberDigitProps>
> {
  public getPattern() {
    let regEx = '[0-9]*';

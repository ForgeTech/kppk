...
describe('FgSpinnerMethodeService', () => {
  ...
  describe('METHODE: assign_set_context', () => {
    ...
    it('THROWS on invalid event type', () => {
      ...
      expect(() => service.assign_set_context({ context, event })).toThrow(
        ZodError
      );
    });
  });
  ...
  describe('METHODE: assign_set_progress', () => {
    ...
    const progressItem1: ProgressItemFgSpinner = {
      name: 'test-1',
      progress: 0,
      finished: false,
    };
    const progressItem2: ProgressItemFgSpinner = {
      name: 'test-2',
      progress: 0,
      finished: false,
    };
    const progressItem2Progress30: ProgressItemFgSpinner = {
      name: 'test-2',
      progress: 30,
      finished: false,
    };
    const progressItem2Progress50: ProgressItemFgSpinner = {
      name: 'test-2',
      progress: 50,
      finished: false,
    };
    const progressItem2Progress100: ProgressItemFgSpinner = {
      name: 'test-2',
      progress: 100,
      finished: false,
    };
    const progressItem2Finished: ProgressItemFgSpinner = {
      name: 'test-2',
      progress: 99,
      finished: true,
    };
    const progressItem2ProgressInvalidToSmall: ProgressItemFgSpinner = {
      name: 'test-2',
      progress: -111,
      finished: true,
    };
    const progressItem2ProgressInvalidToBig: ProgressItemFgSpinner = {
      name: 'test-2',
      progress: 111,
      finished: true,
    };
    const progressItem3: ProgressItemFgSpinner = {
      name: 'test-3',
      progress: 0,
      finished: false,
    };
    ...
    it('CHECK: event with items adds them to context', () => {
      ...
      expect(result1.progressItems).toStrictEqual([
        progressItem1,
        progressItem2Progress30,
        progressItem3,
      ]);
    });
    ...
    it('THROWS: on event item with invalid progress', () => {
      ...
      expect(() => service.assign_set_progress({ context, event })).toThrow(
        ZodError
      );
  ...
  describe('METHODE: raise_spinner_event_stop', () => {
    it("CHECK: returns 'fg.spinner.event.stop' event", () => {
      expect(service.raise_spinner_event_stop().type).toBe(
  ...
  describe('METHODE: raise_spinner_internal_hide', () => {
    it("CHECK: returns 'fg.spinner.internal.hide' event", () => {
      expect(service.raise_spinner_internal_hide().type).toBe(
  ...
  describe('METHODE: raise_spinner_internal_show', () => {
    it("CHECK: returns 'fg.spinner.internal.show' event", () => {
      expect(service.raise_spinner_internal_show().type).toBe(
  ...
  describe('METHODE: respond_spinner_event_context_get_target', () => {
    it('CHECK: returns machineId from context as target', () => {
      ...
      const result = service.respond_spinner_event_context_get_target({
        event,
      });
    ...
    it('THROWS on invalid event type', () => {
      ...
      // https://stackoverflow.com/a/66109855/1622564
      expect(() =>
        service.respond_spinner_event_context_get_target({ event })
      ).toThrow(ZodError);
    });
  });
  ...
  describe('METHODE: respond_spinner_event_context_get_event', () => {
    it("CHECK: returns 'fg.spinner.event.respond_context' event with payload of current context", () => {
      const result = service.respond_spinner_event_context_get_event({
        context,
      });
  ...
  describe('METHODE: raise_spinner_internal_force_hide', () => {
    it("CHECK: returns 'fg.spinner.internal.force_hide' event", () => {
      expect(service.raise_spinner_internal_force_hide().type).toBe(
  ...
  describe('METHODE: raise_spinner_internal_force_show', () => {
    it("CHECK: returns 'fg.spinner.internal.force_show' event", () => {
      expect(service.raise_spinner_internal_force_show().type).toBe(
  ...
  describe('METHODE: raise_spinner_internal_reset_timeout', () => {
    it("CHECK: returns 'fg.spinner.internal.reset_timeout' event", () => {
      expect(service.raise_spinner_internal_reset_timeout().type).toBe(
  ...
  describe('METHODE: guard_force_hide_is_true', () => {
    ...
    it('THROWS on invalid event type', () => {
      ...
      // CAUTION: If testing if methoed throws error and it's not working read
      // https://stackoverflow.com/a/66109855/1622564
      expect(() => service.guard_force_hide_is_true({ event })).toThrow(
        ZodError
      );
    });
  });
  ...
  describe('METHODE: guard_force_show_is_true', () => {
    ...
    it('THROWS on invalid event type', () => {
      ...
      // CAUTION: If testing if methoed throws error and it's not working read
      // https://stackoverflow.com/a/66109855/1622564
      expect(() => service.guard_force_show_is_true({ event })).toThrow(
        ZodError
      );
    });
  });
  ...
  describe('METHODE: guard_allow_timeout_reset_is_true', () => {
    ...
    it('CHECK: returns false', () => {
      ...
      expect(service.guard_allow_timeout_reset_is_true({ context })).toBe(
        false
      );
    });
  });
  ...
  describe('METHODE: guard_delay_auto_dismiss_timeout_error_is_not_zero', () => {
    it('CHECK: returns true', () => {
      expect(
        service.guard_delay_auto_dismiss_timeout_error_is_not_zero({ context })
      ).toBe(true);
    });
    it('CHECK: returns false', () => {

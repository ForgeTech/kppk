...
export const MAX_VALUE_VALIDATOR: any = {
  ...
  useExisting: forwardRef(() => FgMaxValueValidator),
  multi: true,
};
...
export class FgMaxValueValidator implements Validator, OnChanges {
  ...
  private _createValidator() {
    this._validator = FgMaxValueValidator.max(parseFloat(this.max));
  }

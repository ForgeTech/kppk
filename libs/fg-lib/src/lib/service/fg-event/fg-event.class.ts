...
import { FgBaseServiceInterface } from '../../base/fg-base-service.interface';
...
export abstract class FgEventGeneric<
  ...
  DISPATCHER extends FgComponentBaseComponent | FgBaseServiceInterface | object | false,
  DATA
> {
  /** CONSTRUCTOR */
  constructor(
...
export class FgEvent extends FgEventGeneric<
  string,
  FgComponentBaseComponent | FgBaseServiceInterface | object | false,
...
export class FgLiveCycleEvent extends FgEventGeneric<
  string,
  FgComponentBaseComponent | FgBaseServiceInterface | FgBaseLogService,
  object | false
> {}
